...
public class PaymentIncrementRequest {
   ...
   **/
  public PaymentIncrementRequest request(Request request) {
      this.request = request;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PaymentIncrementRequest operation(OperationEnum operation) {
      this.operation = operation;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PaymentIncrementRequest paymentData(PaymentUpdateTransactionData paymentData) {
      this.paymentData = paymentData;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PaymentIncrementRequest transactionData(PaymentUpdateTransactionData transactionData) {
      this.transactionData = transactionData;
      return this;
  }
  ...
  public String toString() {
     ...
     sb.append("PaymentIncrementRequest( ");
