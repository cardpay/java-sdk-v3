...
public class RecurringGatewayResponseRecurringData {
  @SerializedName("id")
   ...
   **/
  public RecurringGatewayResponseRecurringData id(String id) {
      this.id = id;
      return this;
  }
   ...
   * @return bean instance
   **/
  public RecurringGatewayResponseRecurringData separateAuth(Boolean separateAuth) {
      this.separateAuth = separateAuth;
      return this;
  }
  ...
  public String toString() {
     ...
     sb.append("RecurringGatewayResponseRecurringData( ");
