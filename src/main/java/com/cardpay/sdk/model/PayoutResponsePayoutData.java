...
public class PayoutResponsePayoutData {
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData created(String created) {
      this.created = created;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData currency(String currency) {
      this.currency = currency;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData declineCode(String declineCode) {
      this.declineCode = declineCode;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData declineReason(String declineReason) {
      this.declineReason = declineReason;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData extendedDeclineReason(String extendedDeclineReason) {
      this.extendedDeclineReason = extendedDeclineReason;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData id(String id) {
      this.id = id;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData note(String note) {
      this.note = note;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData rrn(String rrn) {
      this.rrn = rrn;
      return this;
  }
   ...
   * @return bean instance
   **/
  public PayoutResponsePayoutData status(StatusEnum status) {
      this.status = status;
      return this;
  }
