...
public class AuthenticationDataRequest {
  ...
  private AuthDataRequest authenticationData = null;
   ...
   **/
  public AuthenticationDataRequest request(Request request) {
      this.request = request;
      return this;
  }

  
  public void setAuthenticationData(AuthDataRequest authenticationData) {
   ...
   * @return bean instance
   **/
  public AuthenticationDataRequest authenticationData(AuthDataRequest authenticationData) {
      this.authenticationData = authenticationData;
      return this;
  }
   ...
   * @return bean instance
   **/
  public AuthenticationDataRequest cardAccount(PaymentRequestCardAccount cardAccount) {
      this.cardAccount = cardAccount;
      return this;
  }
   ...
   * @return bean instance
   **/
  public AuthenticationDataRequest customer(PaymentRequestCustomer customer) {
      this.customer = customer;
      return this;
  }
   ...
   * @return bean instance
   **/
  public AuthenticationDataRequest merchantOrder(PaymentRequestMerchantOrder merchantOrder) {
      this.merchantOrder = merchantOrder;
      return this;
  }
   ...
   * @return bean instance
   **/
  public AuthenticationDataRequest paymentMethod(String paymentMethod) {
      this.paymentMethod = paymentMethod;
      return this;
  }
   ...
   * @return bean instance
   **/
  public AuthenticationDataRequest returnUrls(ReturnUrls returnUrls) {
      this.returnUrls = returnUrls;
      return this;
  }
  ...
  public String toString() {
     ...
     sb.append("AuthenticationDataRequest( ");
