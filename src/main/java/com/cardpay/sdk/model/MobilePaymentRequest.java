...
public class MobilePaymentRequest {
   ...
   **/
  public MobilePaymentRequest request(Request request) {
      this.request = request;
      return this;
  }
   ...
   * @return bean instance
   **/
  public MobilePaymentRequest cardAccount(PaymentRequestCardAccount cardAccount) {
      this.cardAccount = cardAccount;
      return this;
  }
   ...
   * @return bean instance
   **/
  public MobilePaymentRequest customer(PaymentRequestCustomer customer) {
      this.customer = customer;
      return this;
  }

  
  public void setMerchantOrder(MobilePaymentMerchantOrder merchantOrder) {
   ...
   * @return bean instance
   **/
  public MobilePaymentRequest merchantOrder(MobilePaymentMerchantOrder merchantOrder) {
      this.merchantOrder = merchantOrder;
      return this;
  }
   ...
   * @return bean instance
   **/
  public MobilePaymentRequest paymentData(PaymentRequestPaymentData paymentData) {
      this.paymentData = paymentData;
      return this;
  }
   ...
   * @return bean instance
   **/
  public MobilePaymentRequest paymentMethod(String paymentMethod) {
      this.paymentMethod = paymentMethod;
      return this;
  }
   ...
   * @return bean instance
   **/
  public MobilePaymentRequest returnUrls(ReturnUrls returnUrls) {
      this.returnUrls = returnUrls;
      return this;
  }
