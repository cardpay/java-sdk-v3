...
public class DisputeList {
  @SerializedName("data")
  private List<DisputeResponse> data = null;
   ...
   **/
  public DisputeList data(List<DisputeResponse> data) {
      this.data = data;
      return this;
  }

  public DisputeList addDataItem(DisputeResponse dataItem) {
    if (this.data == null) {
   ...
   * @return bean instance
   **/
  public DisputeList hasMore(Boolean hasMore) {
      this.hasMore = hasMore;
      return this;
  }
