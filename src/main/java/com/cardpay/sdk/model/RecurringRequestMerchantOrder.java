...
public class RecurringRequestMerchantOrder {
   ...
   **/
  public RecurringRequestMerchantOrder cryptocurrencyIndicator(Boolean cryptocurrencyIndicator) {
      this.cryptocurrencyIndicator = cryptocurrencyIndicator;
      return this;
  }
   ...
   * @return bean instance
   **/
  public RecurringRequestMerchantOrder description(String description) {
      this.description = description;
      return this;
  }
   ...
   * @return bean instance
   **/
  public RecurringRequestMerchantOrder id(String id) {
      this.id = id;
      return this;
  }
   ...
   * @return bean instance
   **/
  public RecurringRequestMerchantOrder items(List<Item> items) {
      this.items = items;
      return this;
  }

  public RecurringRequestMerchantOrder addItemsItem(Item itemsItem) {
    if (this.items == null) {
   ...
   * @return bean instance
   **/
  public RecurringRequestMerchantOrder shippingAddress(ShippingAddress shippingAddress) {
      this.shippingAddress = shippingAddress;
      return this;
  }
  ...
  public String toString() {
     ...
     sb.append("RecurringRequestMerchantOrder( ");
